...
const useWeb3Contract = () => {
    ...
    const getContract = (contractName) => {
        ...
        if (!web3)
            return null;
        const contractValue = (0, helpers_1.getContractValue)(contractName, chainId);
        // @ts-ignore
        const abiValue = (_a = contracts_1.tokensInfo[chainId][contractName]) === null || _a === void 0 ? void 0 : _a.abi;
        if (!contractValue)
            return null;
